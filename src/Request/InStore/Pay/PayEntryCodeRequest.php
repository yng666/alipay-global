...
class PayEntryCodeRequest
{
    ...
    private $paymentMethod = [
        'paymentMethodType'     => 'CONNECT_WALLET',// 付款方式类型
     ...
     * @param array
     */
    private $paymentFactor = ['inStorePaymentScenario' => 'EntryCode'];
     ...
     */
    private function setPaymentRedirectUrl(array $paymentRedirectUrl)
    {
    ...
    public function formatData(array $params)
    {
        ...
        $validator = new Validator('PayEntryCode');
        ...
        $params['paymentFactor'] = $this->paymentFactor;
