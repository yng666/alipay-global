...
return [
    'rules' => [
        ...
        'order.env.userAgent'                      => 'require|string|in:WEB,WAP,APP,MINI_APP',
        'order.env.osType'                         => 'string|requireWhen:terminalType,WAP,APP,MINI_APP|in:IOS,ANDROID',
        ...
        'paymentFactor.inStorePaymentScenario'     => 'require|=:EntryCode',
